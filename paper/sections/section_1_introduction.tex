...
correction. Hit rates in this range would be insufficient to
overcome typical intraday transaction costs on either asset. Third,
the LLM sentiment nonetheless
out-performs the standard Loughran-McDonald finance dictionary
\citep{loughran2011liability} by about $1$--$6$ percentage points,
is competitive with the FinBERT-tone neural classifier
\citep{yang2020finbert} across primary windows, and produces cross-asset
