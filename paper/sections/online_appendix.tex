\section{Online Appendix: Robustness Tables}
\label{app:online}
...
\input{tables/table_A1_cluster_gap_robustness.tex}
...
\input{tables/table_A2_subsample_magnitude.tex}
\input{tables/table_A3_subsample_direction.tex}
...
\noindent
Five few-shot examples covering geopolitical escalation, dovish Fed
signal, hawkish ECB signal, neutral aid announcement, and corporate
earnings miss anchor the format.
