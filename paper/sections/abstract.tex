...
hit rate) and below transaction costs in a backtest, but the LLM
outperforms both baselines on direction by 2--6 percentage points and
produces asset-specific sentiment on 73.5\% of events. On the
